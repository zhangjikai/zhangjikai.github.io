...
module.exports = [
	...
	},
	{
		...
		"hasCode": true,
		"name": "项目列表展示模板",
		"content": "<p>使用 Vue.js 写的一个展示项目列表的模板，基于 Markdown 文件配置，只需按一定规则编写 Markdown 文件，不用修改源代码。本页面就是使用的该模板。同时该项目逻辑比较简单，可以作为 Vue.js 的一个入门示例项目。\n<!-- more --></p>\n<h2 id=\"-\">使用方法</h2>\n<ol>\n<li>clone 项目到本地<pre class=\"line-numbers language-undefined\"><code class=\" language-undefined\"> git clone git@github.com:zhangjikai/project-list-template.git\n cd project-list-template<span aria-hidden=\"true\" class=\"line-numbers-rows\"><span></span><span></span></span></code></pre></li>\n<li>按照 <a href=\"https://github.com/zhangjikai/project-list-template/blob/master/README.md#markdown-%E6%96%87%E4%BB%B6%E8%A7%84%E5%88%99\">规则</a> 编写 Markdown 文件</li>\n<li>使用 <a href=\"http://project.zhangjikai.com/generator/\">在线工具</a> 转换为 json 文件</li>\n<li>替换 data.json</li>\n<li>运行程序重新编译<pre class=\"line-numbers language-undefined\"><code class=\" language-undefined\"> npm install\n gulp<span aria-hidden=\"true\" class=\"line-numbers-rows\"><span></span><span></span></span></code></pre> 如果不想重新编译文件，可以使用 without-recompile 中的文件，该文件夹下的程序使用 <code>$.getJSON</code> 获取 json 文件，只需替换 json 文件，不需要重新编译。</li>\n</ol>\n",
		"shortIntro": "<p>使用 Vue.js 写的一个展示项目列表的模板，基于 Markdown 文件配置，只需按一定规则编写 Markdown 文件，不用修改源代码。本页面就是使用的该模板。同时该项目逻辑比较简单，可以作为 Vue.js 的一个入门示例项目。</p>\n",
		"tags": [
			"Vue.js",
			"工具"
		],
	...
	},
	{
		...
		"content": "<p>将 Markdown 文件转换为不同主题的 GitHub Page 网页，与 GitHub 提供的相比，优点就是支持的功能更多，并且可以方便的添加扩展。</p>\n<p><a href=\"http://www.zhangjikai.com/page/index.html\">示例预览</a></p>\n",
		"shortIntro": "",
		"tags": [
			"Markdown",
			"GitHub Page",
	...
	},
	{
		...
		"hasHome": true,
		"hasCode": false,
		"name": "Canvas 内部元素事件处理",
		"content": "<p>Canvas 内部元素事件处理的一个小框架，目前支持下面的功能：</p>\n<ul>\n<li>为自定义对象添加以及删除 Listener</li>\n<li>支持 mouseover, mouseout, mouseover, click 事件</li>\n<li>支持 矩形、圆形和多边形</li>\n</ul>\n",
		"shortIntro": "",
		"tags": [
			"Canvas"
		],
		"category": "HTML5 & JS",
		"home": "http://zhangjikai.com/canvas-event/",
		"code": "",
		"github": {
			"star": "true",
			"fork": "true",
			"repo": "zhangjikai/canvas-element-event"
		}
	},
	{
		"id": 9,
		...
		"hasCode": true,
		"name": "Search X",
		"content": "<p>基于Three.js 框架的一个小游戏，找出表面文字和其它的不同的那个立方体。</p>\n",
		"shortIntro": "",
		"tags": [
			"Three.js",
			"游戏"
		...
		"category": "HTML5 & JS",
		"home": "http://searchx.zhangjikai.com/",
		"code": "https://github.com/zhangjikai/searchx",
		"github": {
			"star": "true",
			"fork": "true",
			"repo": "zhangjikai/searchx"
		}
	},
	{
		"id": 10,
		...
		"hasCode": false,
		"name": "Cover It",
		"content": "<p>使用 HTML5 写的一个小游戏，通过绿色按钮控制白色方块移动速度，使白色方块正好覆盖黄色方块。</p>\n",
		"shortIntro": "",
		"tags": [
			"HTML5",
			"游戏"
		...
		"category": "HTML5 & JS",
		"home": "http://www.zhangjikai.com/game/coverit/index.html",
		"code": "",
		"github": {
			"star": false,
			"fork": false,
	...
	},
	{
		...
		"hasCode": false,
		"name": "在线查生字",
		"content": "<p>通过手写在线查生字。</p>\n",
		"shortIntro": "",
		"tags": [
			"工具"
		],
		"category": "HTML5 & JS",
		"home": "http://www.zhangjikai.com/sz/baidu.html",
		"code": "",
		"github": {
			"star": false,
			"fork": false,
	...
	},
	{
		...
		"hasCode": false,
		"name": "在线文字转语音",
		"content": "<p>借助于百度翻译，将文字转换为语音。</p>\n",
		"shortIntro": "",
		"tags": [
			"工具"
		],
		"category": "HTML5 & JS",
		"home": "http://www.zhangjikai.com/text2sound/",
		"code": "",
		"github": {
			"star": false,
			"fork": false,
	...
	},
	{
		...
		"hasCode": true,
		"name": "多行文字转为字符串格式",
		"content": "<p>将原始的多行文字转换为字符串的形式。</p>\n",
		"shortIntro": "",
		"tags": [
			"工具"
		],
		"category": "HTML5 & JS",
		"home": "http://str.zhangjikai.com/",
		"code": "https://github.com/zhangjikai/transform-text-to-string",
		"github": {
			"star": "true",
			"fork": "true",
			"repo": "zhangjikai/transform-text-to-string"
		}
	},
	{
		"id": 14,
	...
	},
	{
		...
		"hasCode": false,
		"name": "Vim 学习笔记",
		"content": "<p>记录 Vim 的相关使用以及一些使用插件。</p>\n",
		"shortIntro": "",
		"tags": [
			"Vim"
		],
	...
	},
	{
		...
		"hasCode": false,
		"name": "并行计算学习笔记",
		"content": "<p>记录并行计算的相关知识，包括 MPI，OpenMP，Pthreads 以及 MIC。</p>\n",
		"shortIntro": "",
		"tags": [
			"MPI",
			"OpenMP",
		...
		"category": "文档",
		"home": "http://parallel.zhangjikai.com/",
		"code": "",
		"github": {
			"star": "true",
			"fork": "true",
			"repo": "zhangjikai/parallel"
		}
	}
];
...
Component.options.__file = "C:\\Users\\ZhangJikai\\Downloads\\project-list-template\\src\\components\\project\\project.vue"
...
Component.options.__file = "C:\\Users\\ZhangJikai\\Downloads\\project-list-template\\src\\components\\sidebar\\sidebar.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
